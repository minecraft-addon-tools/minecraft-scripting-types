...
declare interface IServerSystem<TSystem> extends ISystem<TSystem>, IVanillaServerSystemBase {
     ...
     */
    createComponent<TComponentKey extends keyof ServerComponentTypeMap>(entity: IEntity, componentIdentifier: TComponentKey): ServerComponentTypeMap[TComponentKey] | null;
     ...
     */
    getComponent<TComponentKey extends keyof ServerComponentTypeMap>(entity: IEntity, componentIdentifier: TComponentKey): ServerComponentTypeMap[TComponentKey] | null;
