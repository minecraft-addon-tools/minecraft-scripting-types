...
declare interface IVanillaClientSystemBase {
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.DisplayChat, chatText: string): boolean | null;
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.ExecuteCommand, command: string): boolean | null;
    /**
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.LoadUI, uiName: string): boolean | null;
    /**
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.SendUIEvent, uiEvent: IUIEventParameters): boolean | null
    /**
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.SpawnParticleAttachedEntity, particleParameters: ISpawnParticleAttachedEntityParameters): boolean | null
    /**
     ...
     * @param particleParameters the details of the particle to spawn 
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.SpawnParticleInWorld, particleParameters: IClientSpawnParticleInWorldParameters): boolean | null
    /**
     ...
     */
    broadcastEvent(eventIdentifier: SendToMinecraftClient.UnloadUI, uiName: string): boolean | null
     ...
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.ClientEnteredWorld, callback: (playerEntity: IEntityObject) => void): boolean | null
    /**
     ...
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.HitResultChanged, callback: (hitResultEvent: IHitResultChangedEvent) => void): boolean | null
    /**
     ...
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.HitResultContinuous, callback: (hitResultEvent: IHitResultContinuousEvent) => void): boolean | null
    /**
     ...
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.PickHitResultChanged, callback: (hitResultEvent: IPickHitResultChangedEvent) => void): boolean | null
    /**
     ...
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.PickHitResultContinuous, callback: (hitResultEvent: IPickHitResultContinuousEvent) => void): boolean | null
/**
     * This event is triggered every update and tells you what entity the mouse pointer is pointing to in the world up to 1000 blocks away.
     */
    listenForEvent(eventIdentifier: ReceiveFromMinecraftClient.UIEvent, callback: (uiEvent: string) => void): boolean | null
