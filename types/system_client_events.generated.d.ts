declare interface IVanillaClientSystemBase {
    broadcastEvent(eventIdentifier: BroadcastableClientEvent.ExecuteCommand, eventData: string): boolean | null;
    broadcastEvent(eventIdentifier: BroadcastableClientEvent.DisplayChat, eventData: string): boolean | null;

    listenForEvent(eventIdentifier: MinecraftClientEvent.ClientEnteredWorld, eventData: (eventData: IEntityObject) => void): boolean | null
